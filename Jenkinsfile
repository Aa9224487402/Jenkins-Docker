node {
    ...
    stage('Deploy Docker Image and login'){
      ...
      echo "Docker Image Tag Name: ${dockerImageTag}"
        ...
        sh "docker images"
        sh "docker login -u aryashersingh2 -p @Shreya15" // put PWD
	...
	//sh "read imageid"
	   sh "docker tag 3bf5ebf0cb39  aryashersingh2/myapplication" //must change your name and tag no
        sh "docker push   aryashersingh2/myapplication"
  }
}
